...
void Airplane::move() {
 _position=_position+(_orientation*Vector3(0,0,1)*_velocity)/2;
}

void Airplane::pitchDown() {
   // _angleX+=_increment;
    _orientation.rotate(_increment,Vector3(1,0,0)); // on change l'orientation courante et non l'angle autour de X.
...
void Airplane::rollRight() {
   // _angleZ+=_increment;
    _orientation.rotate(_increment,Vector3(0,0,1)); // on change l'orientation courante et non l'angle autour de X.
...
void Airplane::yawLeft() {
   // _angleY+=_increment;
    _orientation.rotate(_increment,Vector3(0,1,0)); // on change l'orientation courante et non l'angle autour de X.
